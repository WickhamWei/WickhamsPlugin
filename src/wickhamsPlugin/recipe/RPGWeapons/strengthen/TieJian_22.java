...
public class TieJian_22 {
	...
	public TieJian_22() {
		...
		meta.setDisplayName(ChatColor.RESET + ""+ChatColor.BLUE+"精致的铁剑");
//		meta.addEnchant(Enchantment.DURABILITY, 1, false);
		List<String> lore = new ArrayList<>();
		lore.add(ChatColor.RESET + " ");
		lore.add(ChatColor.RESET + "稀有度：" + ChatColor.BLUE + "强化");
		lore.add(ChatColor.RESET + "所需等级："+ChatColor.BLUE+"15");
		level = 15;
		lore.add(ChatColor.RESET + "绑定：自由交易");
		lore.add(ChatColor.RESET+ "基础伤害：7");
		lore.add(ChatColor.RESET+ "基础攻速：0.625");
		lore.add(ChatColor.YELLOW + "" + ChatColor.ITALIC + "这把剑好像闻到了哥布林的血…… --林纳斯");
		...
		recipe2.shape(5, TieJian_12.itemStack);
