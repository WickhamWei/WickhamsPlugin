...
public class TieJian_52 {
	...
	public TieJian_52() {
		...
		meta.setDisplayName(ChatColor.RESET + ""+ChatColor.BLUE+"赫顿士兵短剑");
//		meta.addEnchant(Enchantment.DURABILITY, 1, false);
		List<String> lore = new ArrayList<>();
		lore.add(ChatColor.RESET + " ");
		lore.add(ChatColor.RESET + "稀有度：" + ChatColor.BLUE + "强化");
		lore.add(ChatColor.RESET + "所需等级："+ChatColor.GOLD+"45");
		level = 45;
		...
		recipe2.shape(5, TieJian_42.itemStack);
